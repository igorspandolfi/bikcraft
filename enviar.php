...
// Mudar Aqui o e-mail
$email_envio = "igorspandolfi@msn.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "!IsP842703#"; // Senha do e-mail

$site_name = "Bikcraft"; // Nome do Site
$site_url = "www.bikcraft.com"; // URL do Site

$host_smtp = "mail.outlook.com"; // HOST SMTP Ex: smtp.domain.com.br
